      ...
      <div className="flex w-[550px] px-[48px] pt-[32px] pb-[40px] flex-col items-center gap-[16px] rounded-md bg-[#FFF] relative ">
        <div className="flex flex-col justify-center items-start gap-[28px] self-stretch ">
          ...
          <div className="flex justify-end items-center gap-[20px] self-stretch">
            <button className="flex w-[149px] h-[39px] px-[56px] py-[10px] justify-center items-center gap-[10px] rounded border-[1px] border-[#005DA1] bg-[#FFF]">
              <p className="text-[#005DA1] text-[14px]">Отменить</p>
            </button>
            <button className="flex h-[39px] px-[48px] py-[10px] justify-center items-center gap-[10px] flex-[1_1_0%] rounded bg-[#005DA1]">
